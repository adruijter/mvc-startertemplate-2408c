        ...
        <div class="col-6">
            ...
            <form action="<?= URLROOT; ?>/zangeressen/update" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input value="<?= $data['zangeres']->Nettowaarde; ?>" name="nettowaarde" type="text" class="form-control" id="nettowaarde" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input value="<?= $data['zangeres']->Mobiel; ?>" name="mobiel" type="tel" class="form-control" id="mobiel" required placeholder="+31 6 1234 56 78" pattern="\+31 6 \d{4} \d{2} \d{2}">
                </div>
                <div class="mb-3">
                    <label for="leeftijd" class="form-label">leeftijd</label>
                    <input value="<?= $data['zangeres']->Leeftijd; ?>" name="leeftijd" type="text" class="form-control" id="leeftijd" required>
                </div> 
