...
VALUES
 ('Apple', 'iPhone 16 Pro', 1256.56, 1, NULL, SYSDATE(6), SYSDATE(6)),
 ('Samsung', 'Galaxy S25 Ultra', 1539, 1, NULL, SYSDATE(6), SYSDATE(6)),
 ('Google', 'Pixel 9 Pro', 890, 1, NULL, SYSDATE(6), SYSDATE(6));